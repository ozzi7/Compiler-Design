...
classDecl
	...
	|	'class' Identifier 'extends' Identifier '{' declList? '}'
	;
...
methodHeading
   ...
   |  'void' Identifier '(' formalParamList? ')'
   ;
...
newExpr
	:	'new' Identifier '(' ')'
	|	'new' Identifier '[' simpleExpr ']'
	|	'new' primitiveType '[' simpleExpr ']'
	;
