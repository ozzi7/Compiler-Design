...
public class TestSamplePrograms extends AbstractTestSamplePrograms {
	 ...
	 */
//	public static final File justFile = new File("javali_tests/A4_simple_hidden/floats_with_write/floats4_with_write.javali");
	 ...
	 */
//	public static final File testDir = new File("javali_tests/A4_simple_hidden/floats_with_write");
	...
	public TestSamplePrograms(File file) {
		...
		try {
			this.treefile = new PrintWriter(file.getPath() + ".tree");
